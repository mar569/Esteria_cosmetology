  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-body ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Premium variants for botanical theme
        gold: "bg-gradient-to-r from-accent to-accent/80 text-accent-foreground font-semibold hover:shadow-gold hover:scale-[1.02] active:scale-[0.98]",
        hero: "bg-transparent border-2 border-foreground/80 text-foreground hover:bg-foreground/10 hover:border-foreground backdrop-blur-sm",
        botanical: "bg-gradient-to-r from-primary to-primary/80 text-primary-foreground hover:shadow-glow hover:scale-[1.02] active:scale-[0.98]",
        elegant: "bg-card border border-border text-foreground hover:border-accent/50 hover:shadow-gold/20",
      },
      size: {
